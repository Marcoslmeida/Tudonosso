<?php 
	...
	$sql_servico = "SELECT s.*, c.descricao as cargo, f.nome as nome
					 FROM servicos as s
					 LEFT JOIN  cargo as c ON c.id = s.id_cargo
...
<div class="container">
	...
	<div class="row">
		...
		<table class="table table-bordered table-striped table-hover table-dark">
			...
			<?php while($funcionario = $servicos->fetch_array(MYSQLI_ASSOC)){ ?>
				<tr>
